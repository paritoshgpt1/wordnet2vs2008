...
char *read_index(long offset, FILE *fp) {
	...
	dprintf("read_index(offset = %d, FILE = %x)", offset, fp);
...
char *bin_search(char *searchkey, FILE *fp)
{
	...
	dprintf("bin_search(searchkey = %s, FILE = %x)", searchkey, fp);
...
static int bin_search_key(char *searchkey, FILE *fp)
{
	...
	dprintf("bin_search_key(searchkey = %s, FILE = %x)", searchkey, fp);
...
void copyfile(FILE *fromfp, FILE *tofp)
{
	...
	dprintf("copyfile(fromfp = %x, tofp = %x)", fromfp, tofp);
...
char *replace_line(char *new_line, char *searchkey, FILE *fp)
{
	...
	dprintf("replace_line(new_line = %s, searchkey = %s, fp = %x)", new_line, searchkey, fp);
...
char *insert_line(char *new_line, char *searchkey, FILE *fp)
{
	...
	dprintf("insert_line(new_line = %s, searchkey = %s, fp = %x)", new_line, searchkey, fp);
