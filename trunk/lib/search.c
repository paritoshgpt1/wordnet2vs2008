...
IndexPtr index_lookup(char *word, int dbase)
{
	...
	dprintf("index_lookup(word = %s, dbase = %d)", word, dbase);
...
IndexPtr parse_index(long offset, int dbase, char *line) {
	...
	dprintf("index_lookup(offset = %d, dbase = %d, line = %s)", offset, dbase, line);
...
IndexPtr getindex(char *searchstr, int dbase)
{
	...
	dprintf("getindex(searchstr = %s, dbase = %d)", searchstr, dbase);
...
SynsetPtr read_synset(int dbase, long boffset, char *word)
{
	...
	dprintf("read_synset(dbase = %d, boffset = %d, word = %s)", dbase, boffset, word);
...
SynsetPtr parse_synset(FILE *fp, int dbase, char *word)
{
	...
	dprintf("read_synset(fp = %x, dbase = %d, word = %s)", fp, dbase, word);
